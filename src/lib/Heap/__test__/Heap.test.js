...
describe('Heap', () => {
  ...
  test('Heap - functions - getLeftChildIdx/getRightChildIdx', () => {
    const Heap = new MaxHeap();
  ...
  test('Heap - functions - getLeftChild/getRightChild', () => {
    const Heap = new MaxHeap();
  ...
  test('Heap - functions - getParentIdx', () => {
    const Heap = new MaxHeap();
    Heap.build([55, 39, 1, 5, 10]);
